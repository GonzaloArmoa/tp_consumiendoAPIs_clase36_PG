...
const API = "http://www.omdbapi.com/?apikey=" + process.env.APIKEY;
...
const moviesController = {
        ...
        if (movies.length) {
          ...
          fetch(`${API}&t=${titulo}&type=movie`)
            ...
            .then(async result => {
              ...
              // .match(/\d+/g) => para extraer solo los numeros de un array
              const awardsParsed = awardsArray ? awardsArray.map((award) => +award) : [];
              //parsear los numeros extraidos del array
  ...
  .catch(error => console.log(error));
    ...
    /* fetch(`${API}&t=${titulo}`)
            ...
            }) */ // BUSCAR Y MOSTRAR LA PELICULA CONSUMIENDO LA API
